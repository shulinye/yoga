...
seatedForwardFold = Move("Seated Forward Fold", None, "Seated Forward Fold", 15, harder="Add in a push up!")
...
seatedMeditation = Move("Seated Meditation", None, "Seated Meditation", 5, child, butterflyStretch, scale, staff, *seatedTwist ,extended_time=[20,30,40])
...
flatBack = Move("Flat Back", None, "Flat Back", 5, forwardFold)
...
superMan = Move("Super Man", None, "Raise both your hands and your feet off the ground at the same time. Superman", 15, vinyasa)
...
wideLegStance.addMove(mountainPose)
...
doubleAdd(threeLeggedDog, lowLunge, kneeToElbow, pigeon, runningMan, revolvedRunningMan)
...
doubleAdd(triangle, revolvedTriangle, halfMoon)
