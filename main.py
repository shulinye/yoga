...
superMan = Move("Super Man", None, "Raise both your hands and your feet off the ground at the same time. Superman", 15)
lieOnBack = Move("Lie On Back", None, "Lie on Your Back", 5, superMan)
...
doubleAdd(pigeon, threeLeggedDog)
